...
namespace TheRideYouRent_ST10083869.Controllers
{
    public class RentalController : Controller
    {
        ...
        {
            var theRideYouRentContext = _context.Rentals.Include(r => r.CarNoNavigation).Include(r => r.Driver).Include(r => r.Inspector);
        ...
        public async Task<IActionResult> Create([Bind("RentalId,CarNo,InspectorId,DriverId,DriverName,RentalFee,Startdate,EndDate")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RentalId,CarNo,InspectorId,DriverId,DriverName,RentalFee,Startdate,EndDate")] Rental rental)
        {
